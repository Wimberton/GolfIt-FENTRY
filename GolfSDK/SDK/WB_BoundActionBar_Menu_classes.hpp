...
// Package: WB_BoundActionBar_Menu
...
// WidgetBlueprintGeneratedClass WB_BoundActionBar_Menu.WB_BoundActionBar_Menu_C
// 0x0010 (0x0298 - 0x0288)
class UWB_BoundActionBar_Menu_C final : public UCommonUserWidget
{
public:
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"WB_BoundActionBar_Menu_C">();
	}
	static class UWB_BoundActionBar_Menu_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UWB_BoundActionBar_Menu_C>();
	}
};
