...
// BlueprintGeneratedClass A_DebugBallTrails.A_DebugBallTrails_C
// 0x0090 (0x02B0 - 0x0220)
class AA_DebugBallTrails_C final : public AActor
{
public:
...
public:
	...
	void AddLocationToConnect(const struct FVector& Location, bool Hit, bool DemoMode);
	void ResetColor();
	void DestroyTrailsAfterDeletion(float Time);
	void ExecuteUbergraph_A_DebugBallTrails(int32 EntryPoint);

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"A_DebugBallTrails_C">();
	}
	static class AA_DebugBallTrails_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<AA_DebugBallTrails_C>();
	}
};
