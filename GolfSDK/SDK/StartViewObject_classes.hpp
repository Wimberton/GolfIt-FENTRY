...
// BlueprintGeneratedClass StartViewObject.StartViewObject_C
// 0x0040 (0x0260 - 0x0220)
class AStartViewObject_C final : public AActor
{
public:
...
public:
	void ExecuteUbergraph_StartViewObject(int32 EntryPoint);
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"StartViewObject_C">();
	}
	static class AStartViewObject_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<AStartViewObject_C>();
	}
};
